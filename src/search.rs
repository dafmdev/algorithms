...
mod tests {
    ...
    fn finds_number_near_end_of_list() {
        ...
        assert_eq!(search::binary_search(num_slice, 70), Some(16));
    }
    ...
    fn finds_number_near_start_of_list() {
        ...
        assert_eq!(search::binary_search(num_slice, 5), Some(2));
    }
    ...
    fn finds_char() {
        ...
        assert_eq!(search::binary_search(char_slice, 'l'), Some(11));
    }
    ...
    fn returns_none_for_chars() {
        ...
        assert_eq!(search::binary_search(char_slice, 'l'), None);
    }
}
